...
- Memastikan dashboard Metabase final konsisten dengan 5 tab: Executive Overview, Delivery Fulfillment, Segment Risk, Customer Order Behavior, dan Geolocation.
- Memvalidasi chart dashboard dengan hasil query ClickHouse dan `docs/query_outputs/`.
- Menyusun narasi insight utama untuk paper IEEE dan PPT presentasi.
- Menggunakan priority matrix, delivery drilldown, customer behavior, dan geolocation analysis sebagai dasar rekomendasi awal customer experience.
